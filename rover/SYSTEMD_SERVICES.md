...
**Endpoints**:
- `GET http://100.91.191.47:5001/api/lidar` - Latest LiDAR scan (JSON)
...
curl http://100.91.191.47:5001/api/camera | python3 -m json.tool
```
...
### Mobile RTK Module
- **IP Address**: 100.73.233.124 (Raspberry Pi 5)
- **Dashboard**: Connects to both ports

### RTK Base Station
- **IP Address**: 100.66.67.11
