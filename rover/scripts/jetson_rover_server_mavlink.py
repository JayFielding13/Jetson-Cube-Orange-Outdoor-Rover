...
class RoverState:
    def __init__(self):
        ...
        self.gps_fix_type = 0  # 0=No fix, 1=No fix, 2=2D, 3=3D, 4=DGPS, 5=RTK Float, 6=RTK Fixed
        self.gps_hdop = 0.0
            ...
            if state.mavlink_connected and state.mavlink_connection:
                ...
                if msg:
                    ...
                    if msg_type == 'GLOBAL_POSITION_INT':
                        ...
                        # GPS details: fix type, satellites, HDOP
                        state.gps_fix_type = msg.fix_type
                        state.gps_satellites = msg.satellites_visible
                        state.gps_hdop = msg.eph / 100.0  # Convert to standard HDOP
