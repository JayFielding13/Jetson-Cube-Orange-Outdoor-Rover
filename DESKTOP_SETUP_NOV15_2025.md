...
- **Distributed ROS 2** networking with Jetson (192.168.254.100)
...
- Raspberry Pi 5 Dashboard: 192.168.254.127
...
1. **Sync Rover Project to Desktop**
   ...
   scp -r ros2_ws jay@192.168.254.66:~/
   ```
...
- [x] Network configured (192.168.254.66)
