...
def generate_launch_description():
    ...
    rviz_config_file = os.path.expanduser('~/Git Sandbox/Jetson Cube Orange Outdoor Rover/rover_sensors.rviz')

    # Xbox controller config
    xbox_config_file = os.path.expanduser('~/Git Sandbox/Jetson Cube Orange Outdoor Rover/xbox_rover.config.yaml')
