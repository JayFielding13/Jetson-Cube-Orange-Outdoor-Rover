...
- [ ] Power on Jetson Orin Nano (IP: 192.168.254.100)
...
- [ ] Check RTK corrections still flowing:
  ...
  ```
- [ ] Power on Mobile RTK Module (Raspberry Pi 5, IP: 192.168.254.127)
...
- **RTK Base Station (RTKPi)**: 192.168.254.165
...
```bash
# All services on Jetson (192.168.254.100)
