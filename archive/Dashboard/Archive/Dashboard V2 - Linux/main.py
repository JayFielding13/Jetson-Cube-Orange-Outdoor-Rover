...
class SSHDashboard:
    def __init__(self, root):
        self.root = root
        self.root.title("Raspberry Pi SSH Dashboard - Linux Edition")
    ...
    def on_connection_success(self):
        ...
        self.terminal_output.insert(tk.END, "Connected to Raspberry Pi (Linux Edition)\n")
    ...
    def save_terminal_logs(self):
        ...
        try:
            ...
            if file_path:
                ...
                header = f"SSH Dashboard Terminal Log - Linux Edition\n"
