#!/usr/bin/env python3
"""
Bluetooth Optimized Navigator V6
================================================================================
Optimized tracking thresholds and movement phases for effective signal gradient detection
...
Version: 6.0 - Optimized Signal Tracking
Date: 2025-01-11
================================================================================
"""
...
class BluetoothOptimizedNavigator:
    ...
    def __init__(self, arduino_port='/dev/ttyUSB0', baud=115200):
        ...
        self.signal_improvement_threshold = 1.5 # dBm improvement to consider direction good (reduced)
        self.signal_degradation_threshold = 4   # dBm degradation to trigger turn test (increased)
        ...
        print("🚀 Bluetooth Optimized Navigator V6 Initialized")
