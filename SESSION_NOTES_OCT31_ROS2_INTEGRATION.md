...
**Endpoints**:
- `GET http://192.168.254.100:5001/api/lidar` - Latest LiDAR scan data (JSON)
...
### On Mobile RTK Module (Pi 5 @ 192.168.254.127)
...
```bash
curl http://192.168.254.100:5001/api/sensors/status
curl http://192.168.254.100:5001/api/lidar | python3 -m json.tool
```

### Mobile RTK Module (Pi 5 @ 192.168.254.127)
