...
**Power On Sequence:**
```bash
1. RTK Base Station (100.66.67.11)
   - Wait 60 seconds for GPS lock

2. Jetson Orin Nano (100.91.191.47)
   - Wait 30 seconds for boot
   - Wait 30 more for ROS 2 services

3. Raspberry Pi 5 Dashboard (100.73.233.124)
...
```bash
# From your laptop
ping 100.91.191.47  # Jetson
ping 100.73.233.124  # Dashboard
ping 100.66.67.11  # RTK Base
```
