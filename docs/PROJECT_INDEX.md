...
**Jetson IP:** 100.91.191.47
**Dashboard IP:** 100.73.233.124
**RTK Base IP:** 100.66.67.11
...
scp jetson_rover_server.py jay@100.91.191.47:~/

# Copy multiple files
scp *.py jay@100.91.191.47:~/

# Copy and restart service
scp ros2_unified_bridge.py jay@100.91.191.47:~/
ssh jay@100.91.191.47 "sudo systemctl restart jetson-unified-bridge"
```
...
ssh jay@100.91.191.47 "sudo systemctl status jetson-*"

# Restart specific service
ssh jay@100.91.191.47 "sudo systemctl restart jetson-mavros2"

# View service logs
ssh jay@100.91.191.47 "sudo journalctl -u jetson-mavros2 -f"
```
...
ssh jay@100.91.191.47 "sudo journalctl -u jetson-rtcm-forwarder -n 20"
```
