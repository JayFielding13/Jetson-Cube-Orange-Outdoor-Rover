...
**Ubuntu Desktop (100.73.129.15) - Simulation & LLM Development**
...
To see live data from the Jetson (100.91.191.47):
...
```bash
scp -r ~/ros2_ws/src jay@100.91.191.47:~/ros2_ws/
ssh jay@100.91.191.47 "cd ~/ros2_ws && colcon build"
```
