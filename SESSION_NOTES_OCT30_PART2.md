...
2. **Static IP Applied:**
   ...
   sudo nmcli connection modify 'Ziply-B220' \
       ipv4.method manual \
       ipv4.addresses 192.168.254.100/24 \
...
3. **Module Updated:**
   - `09_dashboard_enhanced.py` Line 122: `self.robot_ip = "192.168.254.100"`

**Results:**
- ✅ Jetson permanently at 192.168.254.100
...
1. **09_dashboard_enhanced.py**
   ...
   - Updated robot IP to static 192.168.254.100 (Line 122)
...
✅ Jetson stable at 192.168.254.100
...
### Hardware Setup
- **Mobile RTK Module:** Raspberry Pi 5 @ 192.168.254.127
- **Rover:** Jetson Orin Nano @ **192.168.254.100** (STATIC)
...
│  192.168.254.100    │  192.168.254.100
│  - REST API Server  │
│  - MAVLink Bridge   │
└──────────┬──────────┘
           │ USB Serial
...
- Configured static IP (192.168.254.100) for Jetson stability
